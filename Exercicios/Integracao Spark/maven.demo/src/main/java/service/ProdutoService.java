...
public class ProdutoService {
	...
	public void makeForm(int tipo, Produto produto, int orderBy) {
		...
		String umProduto = "";
		if(tipo != FORM_INSERT) {
			umProduto += "\t<table class=\"table-form\">";
			umProduto += "\t\t<tr>";
			umProduto += "\t\t\t<td align=\"left\"><font size=\"+2\"><strong>&nbsp;&nbsp;&nbsp;<a href=\"/produto/list/1\">Novo Produto</a></strong></font></td>";
			umProduto += "\t\t</tr>";
			umProduto += "\t</table>";
			umProduto += "\t<br>";			
		}
		...
		if(tipo == FORM_INSERT || tipo == FORM_UPDATE) {
			...
			umProduto += "\t<table class=\"table-form\">";
			umProduto += "\t\t<tr>";
			umProduto += "\t\t\t<td colspan=\"3\" align=\"left\"><font size=\"+2\"><strong>&nbsp;&nbsp;&nbsp;" + name + "</strong></font></td>";
			umProduto += "\t\t</tr>";
			umProduto += "\t\t<tr>";
			umProduto += "\t\t\t<td colspan=\"3\" align=\"left\">&nbsp;</td>";
			umProduto += "\t\t</tr>";
			umProduto += "\t\t<tr>";
			umProduto += "\t\t\t<td>&nbsp;Descrição: <input class=\"input--register\" type=\"textarea\" name=\"descricao\" placeholder=\""+ descricao +"\" required></td>";
			umProduto += "\t\t\t<td>Preco: <input class=\"input--register\" step=\"0.01\" type=\"number\" name=\"preco\" placeholder=\""+ produto.getPreco() +"\" required></td>";
			umProduto += "\t\t\t<td>Quantidade: <input class=\"input--register\" type=\"number\" name=\"quantidade\" placeholder=\""+ produto.getQuantidade() +"\" required></td>";
			umProduto += "\t\t</tr>";
			umProduto += "\t\t<tr>";
			umProduto += "\t\t\t<td>&nbsp;Data de fabricação: <input class=\"input--register\" type=\"datetime-local\" name=\"dataFabricacao\" placeholder=\""+ produto.getDataFabricacao().toString() + "\"required></td>";
			umProduto += "\t\t\t<td>Data de validade: <input class=\"input--register\" type=\"date\" name=\"dataValidade\" placeholder=\""+ produto.getDataValidade().toString() + "\"required></td>";
			umProduto += "\t\t\t<td align=\"center\"><input type=\"submit\" value=\""+ buttonLabel +"\" class=\"input--main__style input--button\"required></td>";
			umProduto += "\t\t</tr>";
			umProduto += "\t</table>";
			umProduto += "\t</form>";		
		...
		String list = new String("<table class=\"table-form table-form-bottom\">");
		list += "\n<tr><td colspan=\"6\" align=\"left\"><font size=\"+2\"><strong>&nbsp;&nbsp;&nbsp;Relação de Produtos</strong></font></td></tr>\n" +
				"\n<tr><td colspan=\"6\">&nbsp;</td></tr>\n" +
    			"\n<tr>\n" + 
        		"\t<td><a href=\"/produto/list/" + FORM_ORDERBY_ID + "\"><strong>ID</strong></a></td>\n" +
        		"\t<td><a href=\"/produto/list/" + FORM_ORDERBY_DESCRICAO + "\"><strong>Descrição</strong></a></td>\n" +
        		"\t<td><a href=\"/produto/list/" + FORM_ORDERBY_PRECO + "\"><strong>Preço</strong></a></td>\n" +
